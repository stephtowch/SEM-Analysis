...
head(data) # lists the first few records to check your data set
...
# Watch: https://www.statology.org/mahalanobis-distance-r/
# Or use SPSS Watch: https://www.youtube.com/watch?v=cKaimZBE8sc
