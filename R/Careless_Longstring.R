...
data = readr::read_csv("C:/Users/Steph/Documents/careless_data.csv")
View(data)
...
write.csv(longstring, row.names = FALSE, "C:/Users/Steph/Documents/longstring.csv")
View(longstring)
...
#write.csv(irv_total, "C:/Users/Halley Pontes/Desktop/irv.csv")
...
write.csv(data2, "C:/Users/Steph/Documents/data2.csv", row.names = FALSE)
View(data2)
...
table(data3$LST)
write.csv(data3, "C:/Users/Steph/Documents/data3.csv", row.names = FALSE)
view(data3)
